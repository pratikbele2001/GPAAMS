...
{
	$loginid 	= "alumni@myprojectcoding.xyz";
	$password 	= "55*5qGVXQs5d";
	$smtpserver = "mail.myprojectcoding.xyz";
	$smtpport 	= 26;
	$mailsender = "Alumni";
	$companyname= "Alumni";
	$facebook = "https://www.facebook.com/Alumni";
	$twitter = "https://www.twitter.com/Alumni";
	$youtube = "https://www.youtube.com/Alumni";
	$linkedin = "https://www.linkedin.com/Alumni";
	$companyaddress  = "Alumni, 9-57, Wadi-e-Hadees, Hyderabad-500005, India | Email us:  hyd2050@gmail.com";
...
//sendmail("dipakzope19@gmail.com", "Dipak" , "My subject title", "My message");
?>